...
<form action="/salle" method="get">
  ...
  <div class="wrap">
    ...
    <div class="tile">
        <img src='https://zupimages.net/up/23/15/v8d2.jpg'/>
        <div class="text">
          <h1> KEVAN </h1>
    ...
    <div class="tile">
        <img src='https://zupimages.net/up/23/15/ud4k.png'/>
        <div class="text">
    ...
    <div class="tile">
        <img src='https://zupimages.net/up/23/15/62ds.jpg'/>
        <div class="text">
          <h1> Mona Lisa</h1>
          <h2 class="animate-text"></h2>
          <p class="animate-text"> ---- Savoir Plus</p>
  ...
  <div class="wrap">
    ...
    <div class="tile">
        <img src='https://zupimages.net/up/23/15/fjmk.jpg'/>
        <div class="text">
          <h1>Nuit Etoile</h1>
          <h2 class="animate-text"></h2>
          <p class="animate-text"> ---- Savoir Plus</p>
